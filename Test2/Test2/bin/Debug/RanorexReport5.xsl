						...
						<ul id="treeList" class="ui-treeList">
							...
							<xsl:if test="./activity/preceding-sibling::item">
								<li class="ui-treeList-item" id="pre-testsuite">
									<h2>
										Before Test Suite
										<xsl:if test="./activity/preceding-sibling::item[@level='Warn']"><span class="ui-module-icon warn"></span> </xsl:if>
									</h2>
							...
							<xsl:if test="./activity/following-sibling::item">
								<li class="ui-treeList-item" id="post-testsuite">
									<h2>
										After Test Suite
										<xsl:if test="./activity/following-sibling::item[@level='Warn']"><span class="ui-module-icon warn"></span> </xsl:if>
									</h2>
									<ul class="pre-testsuite">
										<div class="module-container" style="display:block">
											<div class="module-header"> <xsl:call-template name="levelFilterSelector"/> </div>
